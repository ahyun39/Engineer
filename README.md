...
데이터 엔지니어링, 머신러닝, LLM/RAG, 시스템 설계 학습 및 프로젝트 저장소입니다.
...
데이터베이스 이론부터 웹 크롤링까지 데이터 수집·저장·처리 전반을 다룹니다.
...
LLM 아키텍처 이해부터 실제 RAG 애플리케이션 구현까지 다룹니다.
...
머신러닝·딥러닝·강화학습 이론 및 실습 자료를 포함합니다.
...
Python 주요 프레임워크와 테스트 도구 학습 자료입니다.
